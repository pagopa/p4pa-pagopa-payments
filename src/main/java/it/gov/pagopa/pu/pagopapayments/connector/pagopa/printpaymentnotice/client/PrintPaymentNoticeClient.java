...
public class PrintPaymentNoticeClient {
  ...
  private String getApiKeyFromOrganizationOrBroker(Long organizationId, String subUnitCode, String accessToken) {
    String orgOrBrokerApiKey = organizationService.getOrganizationApiKey(organizationId, OrganizationApiKeyType.GENERATE_NOTICE, subUnitCode, accessToken);
  ...
  public byte[] generateNotice(Long organizationId, NoticeGenerationRequestItemDTO noticeGenerationRequestItemDTO, String accessToken) {
    String apiKey = getApiKeyFromOrganizationOrBroker(organizationId, null, accessToken);
