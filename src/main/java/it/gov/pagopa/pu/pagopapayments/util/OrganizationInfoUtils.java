...
public final class OrganizationInfoUtils {
  ...
  public static OrganizationInfo resolveOrganizationInfo(Organization organization, Broker broker, List<TransferDTO> transfers) {
    ...
    return new OrganizationInfo(fiscalCodePA, companyName);
  }
}
